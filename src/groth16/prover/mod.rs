...
use crate::{
    gpu::GpuName, Circuit, ConstraintSystem, Index, LinearCombination, SynthesisError, Variable,
};
...
where
    ...
    E::G2Affine: GpuName,
{
    prover::create_proof_batch_priority_inner(circuits, params, None, priority)
}
